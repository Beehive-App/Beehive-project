import { AccessTime, Add, AddTask, BorderLeft, CheckCircle, Circle, Delete, DensityLarge, DensityMedium, DragHandle, Edit, FirstPage, HelpOutline, HorizontalRule, Info, LockClock, PriorityHigh, RadioButtonUncheckedSharp, Settings, TaskAlt } from '@mui/icons-material';
import { Box, Button, Checkbox, Dialog, DialogActions, DialogContent, DialogTitle, Divider, Fab, FormControl, IconButton, InputLabel, List, ListItem, ListItemButton, ListItemText, MenuItem, Select, Tab, Tabs, TextField, Tooltip, Typography, useMediaQuery } from '@mui/material'
import { DateTimePicker } from '@mui/x-date-pickers';
import { getMinutes, isSameDay,getHours, startOfDay, startOfToday } from 'date-fns/esm';
import { useState } from 'react';
import { useDispatch, useSelector } from 'react-redux'
import { useTheme } from 'styled-components';
import { useForm } from '../../../../hooks/useForm';
import { completeTasks, setActiveTab, unsetActiveSection } from '../../../../store/Tasks/tasksSlice'
import { startCreatingNewtask, updateSection } from '../../../../store/Tasks/thunks';
import { mainAppTheme } from '../../../../theme/mainAppTheme';
import { TabPanel } from '../../../components/TabPanel';
import { TinyCalendar } from '../components/TinyCalendar';
import { UpperCalendar } from '../components/UpperCalendar';
...
export const TaskSectionView = () => {
  ...
  //useForm 
  const {description,onInputChange,setFormState,formState} = useForm(formData)
  ...
  const onNewTask = async()=>{
    const resp = dispatch( startCreatingNewtask(formState) );
    handleDialogState()
  }
  ...
  const onCompleteTask = (task)=>{  
    ...
    dispatch(completeTasks(newTasks));
